...
const translations = {
  ...
  hi: {
    ...
    characterHeroLabel: 'Dream Valley kirdaar creator',
    characterHeroTitle: 'Dream Valley ka kirdaar banayein',
    characterHeroSubtitle: 'Apni kahaniyon mein ek naya dost laayein.',
    ...
    characterTraitsHelp: '5 tak chuniye. Aap ek se zyada chun sakte hain.',
    characterTraitsSelected: '5 mein se {count} selected',
    characterDetails: 'Details',
    characterGeneration: 'Generation details',
    characterCost: 'Cost',
    characterCurrentCredits: 'Current credits',
    characterCreditsAfter: 'Credits after',
    characterNone: 'Koi nahi',
    characterOf: 'mein se',
    ...
    characterErrorUnsafeInput: 'Kuch details se kirdaar nahi ban sakta. Apni details edit karke phir try karein.',
    characterErrorProfileFailed: 'Kirdaar ka profile poora nahi ban paaya. Koi slot ya credit use nahi hua. Dobara try karein.',
    characterErrorUnsafeProfile: 'Banaye gaye profile ke liye alag details chahiye. Apni choices edit karke phir try karein.',
    characterErrorPortraitFailed: 'Kirdaar ka profile taiyaar tha, lekin tasveer nahi ban paayi. Koi slot ya credit use nahi hua. Dobara try karein.',
    characterErrorReference: 'Reference:',
    characterEditDetails: 'Details edit karein',
    ...
    characterLoading: 'Kirdaar load ho raha hai…',
    characterNotFound: 'Kirdaar nahi mila.',
    characterLoadFailed: 'Yeh kirdaar load nahi ho paaya.',
