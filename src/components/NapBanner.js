...
const wrapStyle = {
  ...
  background: 'linear-gradient(135deg, var(--dv-banner-start) 0%, var(--dv-banner-end) 100%)',
...
const btnStyle = {
  ...
  background: 'linear-gradient(135deg, var(--dv-banner-button-start), var(--dv-banner-button-end))',
