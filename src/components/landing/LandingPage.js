      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          ...
          <div className={styles.footerLinks}>
            ...
            <div className={styles.footerCol}>
              <h4>Get the App</h4>
              <a href="https://apps.apple.com/sg/app/dream-valley-stories/id6759262548" target="_blank" rel="noopener noreferrer">iOS App Store</a>
              <a href="https://play.google.com/store/apps/details?id=com.vervetogether.dreamvalley" target="_blank" rel="noopener noreferrer">Google Play</a>
            </div>
            <div className={styles.footerCol}>
              <h4>Legal</h4>
